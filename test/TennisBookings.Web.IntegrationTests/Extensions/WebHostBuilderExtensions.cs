...
namespace TennisBookings.Web.IntegrationTests.Extensions
{
    public static class WebHostBuilderExtensions
    {
        ...
        public static IWebHostBuilder ConfigureTestDatabase<TLogCategoryName>(this IWebHostBuilder builder, Action<TennisBookingDbContext> configure)
        {
            return builder.ConfigureTestServices(services =>
            {
                ...
                var logger = scopedServices.GetRequiredService<ILogger<TLogCategoryName>>();
