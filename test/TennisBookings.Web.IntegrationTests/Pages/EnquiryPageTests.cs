...
namespace TennisBookings.Web.IntegrationTests.Pages
{
    public class EnquiryPageTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public async Task Post_SendsEmail_WITH_MOCK()
        {
            // SAME TEST above, but using Mock instead of Fake
            ...
            emailService.Verify(s => s.SendAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()),
                Times.Once);
        }
    }
}
